...
class Google {
	...
	public function __construct() {
		...
		$this->client->setApplicationName($CI->config->item('application_name', 'best for login'));
		$this->client->setClientId($CI->config->item('client_id', '795972039102-h4itc76d9n5hns1nkrii7mftv7vcnm90.apps.googleusercontent.com'));
		$this->client->setClientSecret($CI->config->item('client_secret', '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'));
		$this->client->setRedirectUri($CI->config->item('redirect_uri', 'https://pnxschool.com/shubhexa/index.php/ulogin/google_login'));
