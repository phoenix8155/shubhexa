<div class="contentpanel">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
       <form action="<?=file_path('celebrity_admin')?><?=$this->uri->rsegment(1)?>/change_password_insert" method="post" class="form-horizontal row-border" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="<?=file_path('admin')?>dashboard/view">
