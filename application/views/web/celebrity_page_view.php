                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="myself_div">
                                <div class="form-group">
                                    ...
                                    <div class="aon-inputicon-box">
                                        <input class="form-control sf-form-control" maxlength="50" name="myselftext" id="myselftext" type="text" placeholder="Name" data-id=""><span id="myselftext_error"></span>
                            ...
                            <div class="col-md-6" id="to_name_div">
                                <div class="form-group">
                                    <label>To</label>
                                    <div class="aon-inputicon-box">
                                        <input class="form-control sf-form-control" maxlength="50" id="to_name" name="to_name" type="text" placeholder="To" data-id=""><span id="to_name_error"></span>
                                    ...
                                    <div class="aon-inputicon-box">
                                        <select class="form-control sf-form-control" required id="occasion_type" name="occasion_type">
                                        	<?php for ($i = 0; $i < count($occasionList); $i++) {?>
                                        		<option value="<?=str_replace(' ', '_', $occasionList[$i]['occasion_title'])?>"><?=$occasionList[$i]['occasion_title']?></option>
                                        	<?php }?>
												<option value="Customize_Your_Message">Customize Your Message</option>
                                    ...
                                    <div class="aon-inputicon-box">
                                        ...
                                        <div class="editer-wrap">
                                            <div class="editer-textarea">
                                                <textarea placeholder="Message" class="form-control message-template" id="message_help" name="message_help" rows="4"  maxlength="350"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
