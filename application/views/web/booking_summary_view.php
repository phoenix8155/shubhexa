<div id="content">
		                            ...
		                            <div class="row">
		                            	...
		                            	<?php for ($i = 0; $i < count($cartResult); $i++) {?>
		                            		...
		                            		<?php }?>
	                                            ...
	                                            <div class="sf-provi-art-comment"><span style="float: left;color: #062279;font-weight: 900;font-size: 15px;">Price : ₹ <?=$cartResult[$i]['amount']?></span>
	                                            </div>
	                                        </div>
		<?php }?>
									</div>
	...
	$amount = 0;
                    			...
                    			<div class="col-xl-12 sf-upgrade-top-area" style="position: sticky;top: 100px;">
                                    ...
                                    <a href="<?=file_path()?>cart" class="admin-button sf-upgrade-btn">Return to Cart</a>
                                </div>
                            <?php }?>
                    		</div>
                    	</div>
