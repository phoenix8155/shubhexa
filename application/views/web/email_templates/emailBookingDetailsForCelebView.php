                                            ...
                                            <td class="content-wrap">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Hi <b><?php echo $celebrity_name . '</b> ,'; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            <p>We are delighted to inform you that a new booking is just confirmed at Subheksha. Feels good, right?</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table border="1" width="80%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $getBookingDetails['template_message']; ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table>
