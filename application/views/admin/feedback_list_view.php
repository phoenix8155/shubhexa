			...
			<h4 class="panel-title"><?=$sub_title?>
				<span class="pull-right">
					<div class="btn-group pull-right">
						<a class="btn btn-danger btn-small btn_delete" href="" style="margin-left: 5px;">Delete Selected</a>
					</div>
				</span>
			</h4>
		</div>
		<div class="panel-body">
			<table class="table  table-bordered responsive" id="data-table" style="width:100%">
				<thead>
					<tr>
