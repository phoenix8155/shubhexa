		...
		<div class="panel-heading">
			...
			<span class="pull-right">
				<div class="btn-group pull-right">
					<a class="btn btn-success btn-small" href="#<?=file_path('admin')?><?=$this->uri->rsegment(1)?>/addnew/add">Export</a><a class="btn btn-danger btn-small btn_delete" href="" style="margin-left: 5px;">Delete Selected</a>
				</div>
				</span>
			</h4>
		</div>
